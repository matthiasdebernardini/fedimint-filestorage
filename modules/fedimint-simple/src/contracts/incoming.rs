...
///
/// A Simple gateway wanting to claim an incoming HTLC can now use the offer to buy the preimage
...
///
///   1. The decryption results in a valid preimage which is given to the Simple gateway. The
